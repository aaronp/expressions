...
import pipelines.reactive.chain.{ConnectToSinkRequest, ConnectToSinkResponse, CreateChainRequest, CreateChainResponse}
...
object PipelineService {
  ...
  class Instance(repo: SourceRepository, input: Observer[Event], output: Observable[Event])(implicit sched: Scheduler) extends PipelineService {
