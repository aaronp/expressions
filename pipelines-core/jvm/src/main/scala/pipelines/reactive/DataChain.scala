...
object DataChain {
  case class DataSourceStep(key: Int, input: ContentType, output: ContentType, name: String, desc: String, dataSource: DataSource, parent: Option[Int]) {
  ...
  object DataSourceStep {
    ...
    def apply(key: Int, input: ContentType, output: ContentType, name: String, dataSource: DataSource, parent: Option[Int] = None) = {
  ...
  /**
    ...
    * @return
    */
  def apply(source: DataSource, transforms: Seq[(String, Transform)]): Either[String, DataChain] = {
